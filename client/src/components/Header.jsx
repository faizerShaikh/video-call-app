        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <img
              src="/logo.png"
              alt="Synchro Logo"
              className="w-auto h-[54px] object-contain"
            />
          </Link>
          ...
          <div className="flex items-center gap-4">
            {/* Profile link - Hidden during active call, only for authenticated users */}
            {!hideNavigation && user && (
              <Link
                to="/profile"
                className="hover:bg-accent hover:text-accent-foreground rounded-md p-2 hover:text-gray-700 hover:font-medium transition-all duration-300 text-muted-foreground cursor-pointer"
              >
